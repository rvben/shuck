...
coverage-ci:
	cargo llvm-cov --workspace --all-features --ignore-filename-regex 'crates/husk/src/main.rs|crates/husk-agent/src/main.rs|crates/husk-vmm/src/apple_vz.rs' --fail-under-lines 75 --lcov --output-path target/llvm-cov.info
